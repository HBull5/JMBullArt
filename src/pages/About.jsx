    ...
    <Stack spacing={{ xs: 5, md: 7 }}>
      ...
      >
        <Box
          ...
          sx={{ width: "100%", maxHeight: 620, objectFit: "cover", borderRadius: 2 }}
        />
        ...
        <Stack spacing={2.5}>
          ...
          <Typography color="text.secondary" sx={{ lineHeight: 1.7 }}>
            This page is ready for a fuller artist statement, process notes, client list, and education details as those
            pieces are finalized.
          </Typography>
        </Stack>
      </Box>
